    ...
    <div class="card-body">
        ...
        <form method="POST" class="form-horizontal" action="{{ route('profiles.update',$emp->id) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group">
                    <label for="emp_person_code" class="col-form-label">รหัสพนักงาน</label>
                    <input type="text" class="form-control" name="emp_person_code" id="emp_person_code" value="{{$emp->emp_person_code}}" readonly>
                    </div>
                </div>
                <div class="col-12 col-md-3" >
                    <div class="form-group">
